#ifndef BillWidgetDelegate_H
#define BillWidgetDelegate_H

#include <QStyledItemDelegate>
#include <QTimeLine>

class BillWidgetDelegate : public QStyledItemDelegate
{
    Q_OBJECT

public:
    BillWidgetDelegate(QObject *parent = Q_NULLPTR);
