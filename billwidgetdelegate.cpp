...
BillWidgetDelegate::BillWidgetDelegate(QObject *parent)
...
void BillWidgetDelegate::setAnimationDuration(const int duration)
{
    m_timeLine->setDuration(duration);
}

void BillWidgetDelegate::paint(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
...
QSize BillWidgetDelegate::sizeHint(const QStyleOptionViewItem &option, const QModelIndex &index) const
{
...
QTimeLine::State BillWidgetDelegate::animationState()
{
    return m_timeLine->state();
}

void BillWidgetDelegate::paintBackground(QPainter *painter, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
...
void BillWidgetDelegate::paintLabels(QPainter* painter, const QStyleOptionViewItem& option, const QModelIndex& index) const
{
...
void BillWidgetDelegate::setActive(bool isActive)
{
    m_isActive = isActive;
}

void BillWidgetDelegate::setRowRightOffset(int rowRightOffset)
{
    m_rowRightOffset = rowRightOffset;
}

void BillWidgetDelegate::setHoveredIndex(const QModelIndex &hoveredIndex)
{
    m_hoveredIndex = hoveredIndex;
}

void BillWidgetDelegate::setCurrentSelectedIndex(const QModelIndex &currentSelectedIndex)
{
